...
/**
 * Decode and validate the bounded native JSON request envelope.
 *
 * @since  0.1.0
 */
...
{
	/**
	 * The preserved native companion protocol identifier.
	 *
	 * @since  0.1.0
	 */
	...
	/**
	 * The maximum accepted request size in bytes.
	 *
	 * @since  0.1.0
	 */
	...
	/**
	 * Validate the protocol envelope and return its normalized request fields.
	 *
